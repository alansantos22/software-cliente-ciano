...
| 3 | Base do bônus de equipe/liderança | **Cascata (decisão do cliente).** Equipe = 2% de **tudo que a rede abaixo VAI RECEBER no mesmo mês** em que esse bônus é pago (dentro do limite de níveis do título) — compra, recompra, dividendos **e os próprios bônus de equipe/liderança** dos downlines. Idem liderança. **Refinamento 2026-05-30:** como bônus pagam ref+1 e dividendos ref+2, a base do bônus de competência M (pago em M+1) usa os bônus de **M** + os dividendos de **M-1** (ambos pagos em M+1); os dividendos do próprio M pagam só em M+2 e entram na base do mês seguinte. |
